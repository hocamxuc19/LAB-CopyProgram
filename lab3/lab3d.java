...
public class lab3d {
  ...
  private static ArrayList<Person> perArr = new ArrayList<>();
   private  static Scanner sc = new Scanner(System.in);
    public static void main(String[] args) {
         perArr.add(new Person(2,"Nhan Bui",true));
        perArr.add(new Person(3,"A Thi",false));  
        add();
        SapXepTen();
        sc.nextLine();
         searchByName();
    ...
    public static void printInfo(Person p) {
        System.out.println("----------------------------------------");
        System.out.println("| ID | Name | Male");
        System.out.println("|" + p.getId() + "|" + p.getName() + "|" + p.isMale() + "|");
    }
